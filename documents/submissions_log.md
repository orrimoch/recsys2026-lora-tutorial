...
| 028-top3-wrrf-qwen15b-blindsetA | [blindA] | — | — | 0.14 | 0.03 | 0.77 | 2.10 | — | 0.23 | 2026-04-25 | REJECTED — coupling hypothesis FALSIFIED; top-3 prompt gave worst LLM drop yet (−1.05) | 1c172ea |
| 029-cot-user-state-qwen15b-blindsetA | [blindA] | — | — | 0.14 | 0.03 | 0.80 | 2.25 | — | 0.25 | 2026-04-28 | REJECTED — CoT user-state extraction regressed LLM −0.90 on 1.5B; near-identical profile to 022 (persona+word-ban) → ANY structural prompt directive on 1.5B collapses to high-LexDiv low-grounding mode | e13f79f |
