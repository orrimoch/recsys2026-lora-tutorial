...
def main(args):
    ...
    reranker_k2 = int(config.get("reranker_k2", 24))
    reranker_stage1_model = str(config.get("reranker_stage1_model", "gemini-2.5-flash-lite"))
    ...
    sasrec_context_use_goal = bool(config.get("sasrec_context_use_goal", False))
    ...
    music_crs = load_crs_baseline(
        ...
        sasrec_context_use_goal=sasrec_context_use_goal,
